pub use uniswap_v_3_weth_dai_lp_contract::*;
...
pub mod uniswap_v_3_weth_dai_lp_contract {
    #[rustfmt::skip]
    ...
    pub static UNISWAP_V3_WETH_DAI_LP_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl ::ethers::contract::EthLogDecode for uniswap_v3_weth_dai_lpEvents {
        fn decode_log(
            ...
            if let Ok(decoded)
                ...
                return Ok(
                    uniswap_v3_weth_dai_lpEvents::IncreaseObservationCardinalityNextFilter(
                        decoded,
                    ),
                );
            }
    ...
    for uniswap_v3_weth_dai_lpCalls {
